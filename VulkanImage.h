...
struct VulkanImage{
    ...
    void CopyImage(VkDevice device, const VulkanBuffer &dataBuffer, VulkanPool pool, VkQueue graphics);
    void CopyImage(VulkanDevice device, const void*const*datas, uint32_t imageCount, VulkanPool pool, VkQueue graphics);
    void CopyImage(VkDevice device, const VulkanBuffer&dataBuffer, uint32_t imageCount, VulkanPool pool, VkQueue graphics);
